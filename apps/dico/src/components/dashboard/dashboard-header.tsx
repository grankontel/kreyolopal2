...
export const DashboardHeader = ({ token }: { token: string }) => {
  return (
    <header className="flex h-14 items-center gap-4 bg-gray-100/40 px-6 lg:h-[60px] dark:bg-gray-800/40">
      ...
      <div className="sd:flex-1 flex items-center gap-4 md:ml-auto md:gap-2 lg:gap-4">
